// import ProgressBar from '@/components/componts-dashadmin/dashcard-kpi-progressbard';

// // ─── datos estáticos (reemplazar cuando se conecte el backend) ────────────────
...
// // ─── sub-componente interno (solo vive aquí, no vale la pena separarlo) ───────
...
// /**
//  * Tabla de tickets activos para el dashboard.
//  *
//  * Props (todas opcionales mientras sea estático):
//  *  - tickets : array   — lista de tickets (usa STATIC_TICKETS si no se pasa)
//  *  - total   : number  — total de tickets para el footer
//  *  - onVerTodos : fn   — callback del botón "Ver todos"
//  */
...
//                             <th className="py-2.5 pl-5 pr-3 text-left text-[10px] font-semibold uppercase tracking-widest text-gray-400">
//                                 Ticket
//                             </th>
//                             <th className="px-3 py-2.5 text-left text-[10px] font-semibold uppercase tracking-widest text-gray-400">
//                                 Agentes
//                             </th>
//                             <th className="px-3 py-2.5 text-left text-[10px] font-semibold uppercase tracking-widest text-gray-400">
//                                 Prioridad
//                             </th>
//                             <th className="py-2.5 pl-3 pr-5 text-right text-[10px] font-semibold uppercase tracking-widest text-gray-400">
//                                 Progreso
//                             </th>
//                         </tr>
//                     </thead>
...
//                             <tr
//                                 key={t.id}
//                                 className="group transition-colors hover:bg-gray-50 dark:hover:bg-sidebar-accent"
//                             >
//                                 {/* nombre + id */}
